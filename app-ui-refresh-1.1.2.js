...
function renderDashboard(){
  ...
  $('#dashboardNextMatch').innerHTML=nextMatch?`
    ...
    <div class="vc-feature-lines">
      ...
      <div>⌖ ${esc(venueName(nextMatch.venueId))}</div>
    </div>
  ...
  $('#upcomingEvents').innerHTML=upcoming.map(e=>`<div class="vc-event-row">
    ...
    <div><strong>${esc(e.title)}</strong><small>${esc(e.startTime||'')} · ${esc(venueName(e.venueId))}</small></div>
