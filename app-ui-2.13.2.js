...
const playerVisualBadges=p=>`${p?.nationalTeam?`<span class="badge national-team-badge">${nationalFlagSvg()} Selección Nacional</span>`:''}${p?.status==='injured'?`<span class="badge injured visual-status-badge">${injuryCrossSvg()} Lesionada</span>`:''}`;
