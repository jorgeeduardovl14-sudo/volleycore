...
const viewGroups={
  admin:new Set(['dashboard','players','categories','seasons','trainings','attendance','events','venues','announcements','finances','sinpeAdmin','users','userAdmin','shirtAdmin','trainers','import','reports','profile','about']),
